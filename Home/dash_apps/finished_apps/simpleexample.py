...
app.layout = html.Div([
    ...
    dbc.Row([
        ...
        dbc.Col(
            ...
            , width={'size': 3, "offset": 0}),
        dbc.Col(
            dcc.RadioItems(id='radio_channel',
                    options=[
                        {'label': 'one channel', 'value': 'one_channel'},
                        {'label': 'Two channel', 'value': 'Two_channel'},
                    ],
                    value='Two_channel',
    ...
    html.Img(id='image_ch1', style={'height': '50%', 'width': '50%'}),
    html.Img(id='image_ch2', style={'height': '50%', 'width': '50%'})
])


@app.callback(
    [Output('image_ch1', 'src'),
    Output('image_ch2', 'src')],
    [Input('submit-val', 'n_clicks'),
     State('datatable-interactivity', 'active_cell'),
     State('radio_channel','value'),
